package org.reljicb.commons.utils;
...
public class StringUtils
{
	 ...
	 /**
	  * Returns {@link StringUtils}.DEFAULT_NULL_TEXT if text is null. Otherwise it returns text.
	  */
	 ...
	 /**
	  * Returns {@link StringUtils}.DEFAULT_EMPTY_TEXT if text is an empty string. Otherwise it returns text.
	  */
	 ...
	 /**
	  * Returns {@link StringUtils}.DEFAULT_NULL_TEXT if text is null, or {@link StringUtils}.DEFAULT_EMPTY_TEXT if text is an empty string.
